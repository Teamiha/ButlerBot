...
export async function sendMessageToGroup(bot: Bot<MyContext>, groupId: string | number, message: string) {
const messageToSend = `Анонимное сообщение от одного из участников: ${message}`
